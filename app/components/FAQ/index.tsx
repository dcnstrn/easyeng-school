            ...
            {({ open }) => (
              <>
                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left text-2xl font-medium">
                  <span>
                    Кому підходять наші курси по вивченню англійської мови
                  </span>
                  <ChevronUpIcon
                    className={`${
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                  Наші інтерактивні уроки з елементами гри — чудове рішення для
                  дітей різного віку, щоб з цікавістю вивчити англійську мову
                  онлайн
                </Disclosure.Panel>
              </>
            )}
